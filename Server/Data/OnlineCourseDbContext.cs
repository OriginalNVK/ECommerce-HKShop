...
public partial class OnlineCourseDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        ...
        => optionsBuilder.UseSqlServer("Server=ORIGINALNVK\\SQLEXPRESS;Initial Catalog=OnlineCourseDB; User ID=sa; Password=27072004; MultipleActiveResultSets=true;TrustServerCertificate=True;");
